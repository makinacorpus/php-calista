...
class PageTest extends AbstractDrupalTest
{
    public function testEmptyPage()
    {
        ...
        $datasource = $this->getMockBuilder('\MakinaCorpus\Drupal\Dashboard\Page\DatasourceInterface')->getMock();
        $display = $this->getMockBuilder('\MakinaCorpus\Drupal\Dashboard\Page\DisplayInterface')->getMock();
