...
use MakinaCorpus\Calista\Tests\Mock\FooPropertyRenderer;
use MakinaCorpus\Calista\Error\ConfigurationError;

/**
 * Test property renderer basic render methods and renderers introspection
 */
class PropertyRendererTest extends \PHPUnit_Framework_TestCase
{
    private function createPropertyRenderer()
    {
