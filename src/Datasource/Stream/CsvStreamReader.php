...
class CsvStreamReader implements \Iterator, \Countable
{
    ...
    private function checkFile()
    {
        if (!file_exists($this->filename)) {
            throw new CalistaError("File '" . $this->filename . "' does not exists");
        }
        if (!is_readable($this->filename)) {
            throw new CalistaError("File '" . $this->filename . "' cannot be read");
        }
    ...
    private function fetchNextLine()
    {
        ...
        if (false === $line) {
            if (feof($this->handle)) {
                ...
                throw new CalistaError("Error while reading the file '" . $this->filename . "'");
            }
        } else {
            $this->line = $line;
        }
    ...
    private function init()
    {
        if (!$this->handleIsValid()) {
            ...
            if (false === $this->handle) {
                if (feof($this->handle)) {
                    throw new CalistaError("File '" . $this->filename . "' is empty");
                } else {
                    throw new CalistaError("Cannot fopen() file '" . $this->filename . "'");
                }
            }
            ...
            if (false === $this->line) {
                throw new CalistaError("Empty CSV file");
            }
